...
//changing one thing to see if github is working.
	public static void main(String[] args) throws FileNotFoundException {
		int end = 0; //intialize end variable to terminate program if d is entered.
		do {//create all encompasing do-while loop
			Scanner menuKeyboard = new Scanner(System.in);//Create new scanner object for for the menu.
			String menuInput;//Initialize string variable to read user input.
			System.out.println("Welcome to the DnD assistant! \n" + "Please enter a, b, c, or d to continue or exit the program: \n" + "a. Roll die. \n" + "b. Encounter builder. \n" + "c. Name Generator. \n" + "d. Exit. \n"); //Welcome user and display menu.
			menuInput = menuKeyboard.nextLine();//Read the user input.
			while (!menuInput.equals("a") && !menuInput.equals("A") && !menuInput.equals("b")  && !menuInput.equals("b") && !menuInput.equals("c") && !menuInput.equals("C") && !menuInput.equals("d") && !menuInput.equals("D")) {//Validate the user input.
				System.out.println("Error: Please enter on of the options above.");
				menuInput = menuKeyboard.nextLine();
			}
			if (menuInput.equals("a") || menuInput.equals("A")) {//If the user chose A.
				//Option A
			...
			else if (menuInput.equals("b") || menuInput.equals("B")) {// if user chose B.
				 ...
				 */
			else if (menuInput.equals("c") || menuInput.equals("C")) { // if user chose C
				boolean check = true;
